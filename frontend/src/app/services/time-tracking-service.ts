...
export class TimeTrackingService {
  ...
  private auth_token =
    'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyQG1hIiwiZXhwIjoxNjcyMzI0MjIzLCJpYXQiOjE2NzIyMzc4MjMsImF1dGhvcml0aWVzIjpbeyJhdXRob3JpdHkiOiJST0xFX1VTRVIifV19.W3XCeoP1f5Sf7C_bqL_E4_7VJFq4pzgOPQvoVeKA--s';
  ...
  public getDatasource(): Observable<TimeTracker[]> {
    ...
    return this.http.get<TimeTracker[]>(
      'http://localhost:8090/api/timetracking/tracks',
      {
