...
export class UpdateTimeTrackingFormComponent {
  ...
  private parseToTimeTrackExist():TimetrackExist{
    let timeTrackExist : TimetrackExist = new TimetrackExist(this.timeTrack.id,this.elements.value.projects,this.elements.value.kommentar,
      this.elements.value.contingent,this.elements.value.dauer,this.elements.value.date);
