...
INSERT INTO ZEITERFASSUNG (ID, MITARBEITER_ID,KOMMENTAR,DAUER,DATUM,KONTINGENT_ID,PROJEKT_ID) values(1,1,'NO COMMENTS',3,parseDateTime('20220101','yyyyMMdd'),1,1);
INSERT INTO ZEITERFASSUNG (ID, MITARBEITER_ID,KOMMENTAR,DAUER,DATUM,KONTINGENT_ID,PROJEKT_ID) values(2,1,'NO COMMENTS',3,parseDateTime('20220102','yyyyMMdd'),2,2);
INSERT INTO ZEITERFASSUNG (ID, MITARBEITER_ID,KOMMENTAR,DAUER,DATUM,KONTINGENT_ID) values(3,1,'NO COMMENTS',3,parseDateTime('20220103','yyyyMMdd'),3);
INSERT INTO ZEITERFASSUNG (ID, MITARBEITER_ID,KOMMENTAR,DAUER,DATUM,KONTINGENT_ID ) values(4,1,'NO COMMENTS',3,parseDateTime('20220104','yyyyMMdd'),4);
