...
VALUES (1,'Muster Str', 'user@ma', 'Vlad', 'Musterman', '02098247100',1);
INSERT INTO mitarbeiter(id, anschrift, mail, nachname, name, telnr,  abteilung)
VALUES (2,'Andere Str.', 'amin.musterman@gmail.com', 'Amin', 'Musterman', '02098247200',1);
INSERT INTO mitarbeiter(id, anschrift, mail, nachname, name, telnr,  abteilung)
VALUES (3,'Muster Str.', 'max.musterman@gmail.com', 'Max', 'Musterman', '02098247300',2);
INSERT INTO mitarbeiter(id, anschrift, mail, nachname, name, telnr,  abteilung)
VALUES (4,'Dritte Muster Str.', 'kai.musterman@gmail.com', 'Kai', 'Musterman', '02098247400',2);
INSERT INTO mitarbeiter(id, anschrift, mail, nachname, name, telnr,  abteilung)
VALUES (5,'Vierte Muster Str.', 'rudolf.musterman@gmail.com', 'Rudolf', 'Musterman', '02098247500',3);
...
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(1,'titel','beschreibung','08:00','10:00','HIGH','2023-01-27',3,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(2,'titel','beschreibung','10:30','12:00','HIGH','2023-01-28',3,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(3,'titel','beschreibung','08:00','10:00','HIGH','2023-01-29',3,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(4,'titel','beschreibung','10:30','12:00','HIGH','2023-01-30',3,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(5,'titel','beschreibung','10:30','12:00','HIGH','2023-01-31',3,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(6,'titel','beschreibung','08:00','10:00','HIGH','2023-02-01',3,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(7,'titel','beschreibung','10:30','12:00','HIGH','2023-02-02',3,1);