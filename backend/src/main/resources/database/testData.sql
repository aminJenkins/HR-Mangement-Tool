...
--insert into TERMIN (ID,BESCHREIBUNG,BIS,PRIORITY,VON,PROJEKT_ID) values(1,'beschreibung',parseDateTime('20140101000000','yyyyMMddHHmmss'),'high',parseDateTime('20150101000000','yyyyMMddHHmmss'),1)
