...
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(1,'titel','beschreibung','08:00','10:00','high','2022-01-02',1,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(2,'titel','beschreibung','10:30','12:00','high','2022-01-02',1,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(3,'titel','beschreibung','08:00','10:00','high','2022-01-03',1,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(4,'titel','beschreibung','10:30','12:00','high','2022-01-03',1,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(5,'titel','beschreibung','10:30','12:00','high','2022-01-05',1,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(6,'titel','beschreibung','08:00','10:00','high','2022-01-06',1,1);
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BEGINN,ENDE, PRIORITY,DATUM, PROJEKT_ID,ERSTELLER_ID) values(7,'titel','beschreibung','10:30','12:00','high','2022-01-06',1,1);
