...
INSERT INTO TERMIN (ID,TITEL,BESCHREIBUNG,BIS,PRIORITY,VON,PROJEKT_ID) values(1,'titel','beschreibung',parseDateTime('20140101','yyyyMMdd'),'high',parseDateTime('20150101000000','yyyyMMddHHmmss'),1)
INSERT INTO ZEITERFASSUNG (ID, MITARBEITER_ID,KOMMENTAR,DAUER,DATUM) values(1,1,'NO COMMENTS',3,parseDateTime('20220101','yyyyMMdd'));
INSERT INTO ZEITERFASSUNG (ID, MITARBEITER_ID,KOMMENTAR,DAUER,DATUM) values(2,1,'NO COMMENTS',3,parseDateTime('20220102','yyyyMMdd'));
INSERT INTO ZEITERFASSUNG (ID, MITARBEITER_ID,KOMMENTAR,DAUER,DATUM) values(3,1,'NO COMMENTS',3,parseDateTime('20220103','yyyyMMdd'));
INSERT INTO ZEITERFASSUNG (ID, MITARBEITER_ID,KOMMENTAR,DAUER,DATUM) values(4,1,'NO COMMENTS',3,parseDateTime('20220104','yyyyMMdd'));
--INSERT INTO ZEITERFASSUNG (ID, MITARBEITER_ID,KOMMENTAR,DAUER,DATUM) values(5,(select ID from MITARBEITER where MAIL = 'user@ma'),'NO COMMENTS',3,parseDateTime('20220104','yyyyMMdd'));
